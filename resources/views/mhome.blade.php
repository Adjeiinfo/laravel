...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('../../assets_backend/assets/images/favicon.png')}}">
    <title>Matrix Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="{{asset('../../assets_backend/assets/libs/flot/css/float-chart.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{asset('../../dist_backend/dist/css/style.min.css')}}" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('../../assets_backend/assets/images/logo-icon.png')}}" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{asset('../../assets_backend/assets/images/logo-text.png')}}" alt="homepage" class="light-logo" />
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="max-height: 130px;">
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="../../assetsassets/images/users/4.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text active w-100">
                                        <h6 class="font-medium">Michael Jorden</h6>
                                        <span class="m-b-15 d-block">Lorem Ipsum is simply dummy text of the printing and type setting industry. </span>
                                        <div class="comment-footer">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="{{asset('../../assets_backend/assets/images/background/img4.jpg')}}" class="img-fluid">
                                    </div>
                                </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="{{asset('../../assets_backend/assets/libs/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{asset('../../assets_backend/assets/libs/popper.js/dist/umd/popper.min.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/extra-libs/sparkline/sparkline.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('../../dist_backend/dist/js/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('../../dist_backend/dist/js/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('../../dist_backend/dist/js/custom.min.js')}}"></script>
    <!--This page JavaScript -->
    <!-- <script src="../../dist/js/pages/dashboards/dashboard1.js"></script> -->
    <!-- Charts js Files -->
    <script src="{{asset('../../assets_backend/assets/libs/flot/excanvas.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/flot/jquery.flot.pie.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/flot/jquery.flot.time.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/flot/jquery.flot.stack.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/flot/jquery.flot.crosshair.js')}}"></script>
    <script src="{{asset('../../assets_backend/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{asset('../../dist_backend/dist/js/pages/chart/chart-page-init.js')}}"></script>
