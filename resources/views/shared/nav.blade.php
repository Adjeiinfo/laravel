<nav>
    <ul class="nav nav-pills">
        <li role="presentation" class="nav-item">
            <a class="nav-link {!! $tools->fullUrlIs(action('AdminPostsController@index')) ? "active" : "" !!}"
                href="{{ action('AdminPostsController@index') }}">{{ trans('lang.nav-active-tickets') }}
        ...
        <li role="presentation" class="nav-item">
            <a class="nav-link {!! $tools->fullUrlIs(action('AdminPostsController@indexComplete')) ? "active" : "" !!}"
                 href="{{ action('AdminPostsController@indexComplete') }}">{{ trans('lang.nav-completed-tickets') }}
                <span class="badge badge-pill badge-secondary">
                    <?php 
                    /*    if ($u->isAdmin()) {
