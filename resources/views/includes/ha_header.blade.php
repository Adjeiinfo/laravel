  <head>
    ...
    <link rel="icon" href="{{asset('public/images/image_backend/imagetest.jpg')}}" type="image/ico" />
    ...
    <!-- JQVMap -->
    <link href="{{asset('vendors/vendor_backend/jqvmap/dist/jqvmap.min.css')}}" rel="stylesheet"/>
    <!-- bootstrap-daterangepicker -->
    <link href="{{asset('vendors/vendor_backend/bootstrap-daterangepicker/daterangepicker.css')}}" rel="stylesheet">

    <!-- Custom Theme Style -->
    <link href="{{asset('build/build_backend/css/custom.min.css')}}" rel="stylesheet">
